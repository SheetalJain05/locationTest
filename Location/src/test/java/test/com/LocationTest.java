...
public class LocationTest {
  ...
  public void testLocation() throws Exception {
    ...
    driver.findElement(By.id("q")).sendKeys("60004");
    ...
    new Select(driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Display filters.'])[1]/following::select[1]"))).selectByVisibleText("Select a distance");
    driver.findElement(By.id("q")).clear();
    driver.findElement(By.id("q")).sendKeys("60004");
  }
